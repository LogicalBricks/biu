...
describe Hotel do
  ...
  it { should validate_presence_of(:total_habitaciones) }
  it { should validate_presence_of(:costo) }
  it { should validate_numericality_of(:clasificacion) }
  it { should validate_numericality_of(:total_habitaciones) }
  it { should validate_numericality_of(:costo) }

  it { should_not allow_value(4.5).for(:clasificacion) }
  it { should_not allow_value(-5).for(:clasificacion) }
  it { should_not allow_value(4.5).for(:total_habitaciones) }
  it { should_not allow_value(-5).for(:total_habitaciones) }
  it { should_not allow_value(-5).for(:costo) }
  it { should allow_value(4.5).for(:costo) }
